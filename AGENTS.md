...
- NEVER edit: `AGENTS.md`, `CLAUDE.md`, `.claude/settings.json`, `.mcp.json`,
...
## ENFORCEMENT LAYER — PLATFORM SPECIFICS
...
- Generate an Artifact (plan) before writing code — auto-proceed unless blocked on a critical decision
